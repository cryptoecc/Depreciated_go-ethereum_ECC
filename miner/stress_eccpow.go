...
// This file contains a miner stress test based on the eccpow consensus engine.
package main
...
func main() {
	...
	// Pre-generate the eccpow mining DAG so we don't race

	// Create an eccpow network based off of the Ropsten config
...
// makeGenesis creates a custom eccpow genesis block based on some pre-defined
// faucet accounts.
...
func makeMiner(genesis *core.Genesis) (*node.Node, error) {
	...
	if err := stack.Register(func(ctx *node.ServiceContext) (node.Service, error) {
		return eth.New(ctx, &eth.Config{
			...
			eccpow:          eth.DefaultConfig.eccpow,
